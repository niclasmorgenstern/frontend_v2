            ...
            <div className='w-full sm:w-[500px] bg-white rounded-lg p-8'>
                ...
                <form onSubmit={handleRegistration}>
                    <div className='mb-4'>
                        ...
                        <input value={email} onChange={(event) => setEmail(event.target.value)} placeholder="Enter your email" type="text" id='name' className='w-full border-2 border-gray-200 bg-transparent rounded-lg py-2 px-4 mt-1 focus:border-blue-500 focus:outline-none' autoFocus required/>
                    </div>
                    <div className='mb-4'>
                    ...
                    <p className='text-center text-gray-500 mb-4'>
                        ...
                        <br />
                        <Link to="#" className="text-gray-700 font-semibold px-2">Terms and Services</Link>
                        and 
                        <Link to="#" className="text-gray-700 font-semibold px-2">Privacy Policy</Link>                    
                    </p>
                    <button type='submit' className='w-full block bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white font-semibold rounded-lg p-2'>Create Account</button>
                </form>
